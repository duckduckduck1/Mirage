...
## Шаг 3. Домен и клиентские ссылки
...
В 3x-ui создай отдельный inbound:
...
| **Клиент** | `ss-main` или имя устройства |
| **Лимит трафика** | `0` |
| **Срок действия** | пусто |
...
Импортируй профиль в Hiddify или другой клиент и проверь, что трафик идёт через
резервный inbound.

## Шаг 5. Telegram-прокси mtg
...
## Шаг 6. Бэкап и миграция

После рабочей настройки сделай первый бэкап панели и сохрани его вне git:
...
- [ ] В клиентской ссылке указан `vpn.ДОМЕН`.
