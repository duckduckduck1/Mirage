...
2. `ansible-playbook` — восстановить базовый доступ, `ufw` и `fail2ban`; затем
   установить сервисы по следующим playbook'ам, когда они появятся.
...
администратора по SSH-ключу и настраивает базовую защиту. Следующая цель —
кодифицировать установку 3x-ui/Xray, Shadowsocks и mtg.
